...
public class AtividadeBiblioteca {
    ...
    public static void main(String[] args) throws SQLException {
        // CriaÃ§Ã£o da Classe BancoDados
        BancoDados bd = new BancoDados();

        // EndereÃ§o para conexÃ£o ao BD
        String urlBD = "jdbc:mysql://localhost:3306/Biblioteca2?user=root&password=24724521";
        ...
        System.out.println("\nMenu Inicial;");
        System.out.println("Qual aÃ§Ã£o deseja realizar no Banco de Dados:");
        ...
        if (escolhaInicial == 1){
            ...
            String query=
                    "select livro.isbn as 'ISBN', livro.titulo as 'TÃ­tulo', livro.ano as 'Ano', editora.nome as 'Editora', \n" +
            ...
            if (resultado != null){
                while (resultado.next()) {
                    System.out.println("IBSN: "+resultado.getString("isbn")
                            +"\t TÃ­tulo: "+resultado.getString("TÃ­tulo")
